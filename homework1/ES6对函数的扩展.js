...
var point = {
    ...
    moveTo:function (x,y) {
        //内部嵌套函数
        function moveToX() {
            this.x = x;//this绑定到了window下
        }
        //内部嵌套函数
        function moveToY() {
            this.y = y;//this绑定到了window下
        }
        moveToX();
        moveToY();
    }
...
//console.log(point.x,point.y);  //2  2
...
//Part333333333333 扩展知识 call与apply的转换 两者之间的区别 可以通过...Rest和...Spread转换
function abc(...v){
    console.log(v)
}
o1 = {};
abc.call(o1,...[1,2,3]);//等效于 abc.apply(o1,[1,2,3]); 输出[1,2,3]
